...
### Added
- **Enhanced Indexing Verification** - Improved sync detection for large/image-heavy PDFs with a 5-second double-confirmation phase.
- **Per-File Row Locking** - Precise monitoring of individual source items to prevent false positives in batch mode.
- **Dynamic Timeouts** - Extended indexing wait buffer to 10 minutes for massive documents.
