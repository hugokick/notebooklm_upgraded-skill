...
### Step 5: Upload Sources to a Notebook

Upload files (PDF, images, docs, audio) or add YouTube links directly to a notebook's sources via browser automation.

```bash
# Upload a YouTube link to the active notebook
python scripts/run.py upload_source.py --youtube "https://www.youtube.com/watch?v=VIDEO_ID"
...
**How it works:**
1. Opens the notebook in an authenticated browser
2. Clicks the "Sources" tab, then "+ Add sources"
3. For URLs: pastes into the search bar and submits
